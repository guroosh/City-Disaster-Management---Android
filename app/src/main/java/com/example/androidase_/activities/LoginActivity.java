...
//        });
                    ...
                    try {
                        if (returnValue[0] == null) {
                            ...
                            if (returnValue[0].code() == 200) {
                                ...
                                startNextActivity(isCommonUser, username, password, true, commonUserAfterLoginPOJO[0].referenceCode);
                                a.runOnUiThread(new Runnable() {
                                    public void run() {
    ...
    private void startNextActivity(boolean isCommonUser, String username, String password, boolean isUserNameSame, String referenceCode) {
        if (!username.equals("") && !password.equals("") && isUserNameSame) {
            ...
            editor.putBoolean("isCommonUser", isCommonUser);
            editor.putString("userReferenceCode", referenceCode);
            editor.apply();
